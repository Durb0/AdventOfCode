package exercises.aoc2022.day07;
 ...
 * Exercise's input is <a href="https://adventofcode.com/2022/day/7/input">here</a>
 * </pre>
 */
public class AOCRunner extends A_AOC {
    ...
    public void test() {
        if(isExample) {
            super.test(95437, 24933642);
        } else {
            super.test(919137, 2877389);
        }
    }
